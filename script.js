...
function loadMenu() {
    ...
    fetch('./pizza.json')
        ...
        .then(data => {
            ...
            const pizzasList = data.pizzas || data;

            if (Array.isArray(pizzasList) && pizzasList.length > 0) {
                const categories = {};
                ...
                for (const categoryName in categories) {
                    ...
                    categories[categoryName].forEach(pizza => {
                        const priceS = pizza.prices ? pizza.prices.S : pizza.price_small;
                        const priceM = pizza.prices ? pizza.prices.M : pizza.price_medium;
                        const priceL = pizza.prices ? pizza.prices.L : pizza.price_large;
                        ...
                        menuSection.innerHTML += `
                            <div class="pizza-card">
                                ...
                                <div class="pizza-price">
                                    <span class="size-btn">S<br> ${priceS} L.E</span>
                                    <span class="size-btn">M<br> ${priceM} L.E</span>
                                    <span class="size-btn">L<br> ${priceL} L.E</span>
                                </div>
